#ifndef OTHERMODELS_H
#define OTHERMODELS_H
...
public:
	...
	OtherModels(int id, string filename, ID3D10Device* device, ID3D10ShaderResourceView* diff, ID3D10ShaderResourceView* spec = TextureManager::mDefaultSpec, D3DXVECTOR3 position = D3DXVECTOR3(0,0,0), D3DXVECTOR3 rotation = D3DXVECTOR3(0,0,0), D3DXVECTOR3 scale = D3DXVECTOR3(1,1,1));
